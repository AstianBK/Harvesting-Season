...
@OnlyIn(Dist.CLIENT)
public class KettleScreenMenu extends AbstractContainerScreen<KettleContainerMenu> implements RecipeUpdateListener {
    private static final ResourceLocation RECIPE_BUTTON_LOCATION = new ResourceLocation("textures/gui/recipe_button.png");
    private static final ResourceLocation TEXTURE = new ResourceLocation(HarvestingSeason.MODID,"textures/gui/kettle_gui.png");
    ...
    public KettleScreenMenu(KettleContainerMenu p_97741_, Inventory p_97742_, Component p_97743_) {
    ...
    protected void renderBg(GuiGraphics p_282928_, float p_281631_, int p_281252_, int p_281891_) {
        ...
        if (this.menu.hasWater()) {
            p_282928_.blit(this.texture, i + 125, j + 53, 176, 10, 15, 11);
        }
