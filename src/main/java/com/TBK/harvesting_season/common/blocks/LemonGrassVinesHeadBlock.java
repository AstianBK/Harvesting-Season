...
public class LemonGrassVinesHeadBlock extends GrowingPlantHeadBlock {
    public static final VoxelShape SHAPE = Block.box(4.0D, 0.0D, 4.0D, 12.0D, 15.0D, 12.0D);
    public LemonGrassVinesHeadBlock(Properties p_53928_) {
    ...
    protected Block getBodyBlock() {
        return HSBlock.LEMON_GRASS_BODY.get();
    }
}
